...
public class JON extends Fighter{
	...
	public void InitializeImages() throws IOException{
		rest[0] = ImageIO.read(new File("JR1.png"));
		rest[1] = ImageIO.read(new File("JR2.png"));
		rest[2] = ImageIO.read(new File("JR3.png"));
		rest[3] = ImageIO.read(new File("JR4.png"));
		
		punch[0] = ImageIO.read(new File("JP1.png"));
		punch[1] = ImageIO.read(new File("JP2.png"));
		punch[2] = ImageIO.read(new File("JP3.png"));
		punch[3] = ImageIO.read(new File("JP4.png"));
		punch[4] = ImageIO.read(new File("JP5.png"));
		punch[5] = ImageIO.read(new File("JP6.png"));
		
		Rpunch[0] = ImageIO.read(new File("JP1R.png"));
		Rpunch[1] = ImageIO.read(new File("JP2R.png"));
		Rpunch[2] = ImageIO.read(new File("JP3R.png"));
		Rpunch[3] = ImageIO.read(new File("JP4R.png"));
		Rpunch[4] = ImageIO.read(new File("JP5R.png"));
		Rpunch[5] = ImageIO.read(new File("JP6R.png"));
		
		walk[0] = ImageIO.read(new File("JW1.png"));
		walk[1] = ImageIO.read(new File("JW2.png"));
		walk[2] = ImageIO.read(new File("JW3.png"));
		
		Rwalk[0] = ImageIO.read(new File("JW1R.png"));
		Rwalk[1] = ImageIO.read(new File("JW2R.png"));
		Rwalk[2] = ImageIO.read(new File("JW3R.png"));
		
		jump = ImageIO.read(new File("JJ.png"));
		hurt = ImageIO.read(new File("JH1.png"));
		
		Rjump = ImageIO.read(new File("JJR.png"));
		Rhurt = ImageIO.read(new File("JH1R.png"));
		
		Rrest[0] = ImageIO.read(new File("JR1R.png"));
		Rrest[1] = ImageIO.read(new File("JR2R.png"));
		Rrest[2] = ImageIO.read(new File("JR3R.png"));
		Rrest[3] = ImageIO.read(new File("JR4R.png"));
		
		arial[0] = ImageIO.read(new File("JA1.png"));
		arial[1] = ImageIO.read(new File("JA2.png"));
		arial[2] = ImageIO.read(new File("JA3.png"));
		Rarial[0] = ImageIO.read(new File("JA1R.png"));
		Rarial[1] = ImageIO.read(new File("JA2R.png"));
		Rarial[2] = ImageIO.read(new File("JA3R.png"));
		
		fall[0] = ImageIO.read(new File("JF1.png"));
		fall[1] = ImageIO.read(new File("JF2.png"));	
