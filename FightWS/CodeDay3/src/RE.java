...
public class RE extends Fighter{
	...
	public void InitializeImages() throws IOException{
		rest[0] = ImageIO.read(new File("RER1.png"));
		rest[1] = ImageIO.read(new File("RER2.png"));
		rest[2] = ImageIO.read(new File("RER3.png"));
		rest[3] = ImageIO.read(new File("RER4.png"));
		
		punch[0] = ImageIO.read(new File("REP1.png"));
		punch[1] = ImageIO.read(new File("REP1.png"));
		punch[2] = ImageIO.read(new File("REP2.png"));
		punch[3] = ImageIO.read(new File("REP2.png"));
		punch[4] = ImageIO.read(new File("REP3.png"));
		punch[5] = ImageIO.read(new File("REP3.png"));
		
		Rpunch[0] = ImageIO.read(new File("REP1R.png"));
		Rpunch[1] = ImageIO.read(new File("REP1R.png"));
		Rpunch[2] = ImageIO.read(new File("REP2R.png"));
		Rpunch[3] = ImageIO.read(new File("REP2R.png"));
		Rpunch[4] = ImageIO.read(new File("REP3R.png"));
		Rpunch[5] = ImageIO.read(new File("REP3R.png"));
		
		walk[0] = ImageIO.read(new File("REW1.png"));
		walk[1] = ImageIO.read(new File("REW4.png"));
		walk[2] = ImageIO.read(new File("REW6.png"));
		
		Rwalk[0] = ImageIO.read(new File("REW1R.png"));
		Rwalk[1] = ImageIO.read(new File("REW4R.png"));
		Rwalk[2] = ImageIO.read(new File("REW6R.png"));
		
		jump = ImageIO.read(new File("REJ1.png"));
		hurt = ImageIO.read(new File("REF1.png"));
		
		Rjump = ImageIO.read(new File("REJ1R.png"));
		Rhurt = ImageIO.read(new File("REF1R.png"));
		
		Rrest[0] = ImageIO.read(new File("RER1R.png"));
		Rrest[1] = ImageIO.read(new File("RER2R.png"));
		Rrest[2] = ImageIO.read(new File("RER3R.png"));
		Rrest[3] = ImageIO.read(new File("RER4R.png"));
		
		arial[0] = ImageIO.read(new File("REA1.png"));
		arial[1] = ImageIO.read(new File("REA1.png"));
		arial[2] = ImageIO.read(new File("REA1.png"));
		Rarial[0] = ImageIO.read(new File("REA1R.png"));
		Rarial[1] = ImageIO.read(new File("REA1R.png"));
		Rarial[2] = ImageIO.read(new File("REA1R.png"));
		
		fall[0] = ImageIO.read(new File("REF1.png"));
		fall[1] = ImageIO.read(new File("REF2.png"));	
		Rfall[0] = ImageIO.read(new File("REF1R.png"));
		Rfall[1] = ImageIO.read(new File("REF2R.png"));
		
		rShield = ImageIO.read(new File("RES1.png"));
		lShield = ImageIO.read(new File("RES1R.png"));
	}
