...
public class SAS extends Fighter{
	...
	public SAS(int PlayerNum){
		super(PlayerNum);	
		attacks[0] = new hAttack(240,10, 1); //radius, damage, attack num
		attacks[1] = new aAttack(270, 10, 2);
		try {
			InitializeImages();
		} catch (IOException e) {
	...
	public void InitializeImages() throws IOException{
		rest[0] = ImageIO.read(new File("SR1.png"));
		rest[1] = ImageIO.read(new File("SR1.png"));
		rest[2] = ImageIO.read(new File("SR2.png"));
		rest[3] = ImageIO.read(new File("SR2.png"));
		
		punch[0] = ImageIO.read(new File("SP1.png"));
		punch[1] = ImageIO.read(new File("SP1.png"));
		punch[2] = ImageIO.read(new File("SP1.png"));
		punch[3] = ImageIO.read(new File("SP2.png"));
		punch[4] = ImageIO.read(new File("SP2.png"));
		punch[5] = ImageIO.read(new File("SP2.png"));
		
		Rpunch[0] = ImageIO.read(new File("SP1R.png"));
		Rpunch[1] = ImageIO.read(new File("SP1R.png"));
		Rpunch[2] = ImageIO.read(new File("SP1R.png"));
		Rpunch[3] = ImageIO.read(new File("SP2R.png"));
		Rpunch[4] = ImageIO.read(new File("SP2R.png"));
		Rpunch[5] = ImageIO.read(new File("SP2R.png"));
		
		walk[0] = ImageIO.read(new File("SW1.png"));
		walk[1] = ImageIO.read(new File("SW3.png"));
		walk[2] = ImageIO.read(new File("SW4.png"));
		
		Rwalk[0] = ImageIO.read(new File("SW1R.png"));
		Rwalk[1] = ImageIO.read(new File("SW3R.png"));
		Rwalk[2] = ImageIO.read(new File("SW4R.png"));
		
		jump = ImageIO.read(new File("SJ.png"));
		hurt = ImageIO.read(new File("SH.png"));
		
		Rjump = ImageIO.read(new File("SJR.png"));
		Rhurt = ImageIO.read(new File("SHR.png"));
		
		Rrest[0] = ImageIO.read(new File("SR1R.png"));
		Rrest[1] = ImageIO.read(new File("SR1R.png"));
		Rrest[2] = ImageIO.read(new File("SR2R.png"));
		Rrest[3] = ImageIO.read(new File("SR2R.png"));
		
		arial[0] = ImageIO.read(new File("SA1.png"));
		arial[1] = ImageIO.read(new File("SA2.png"));
		arial[2] = ImageIO.read(new File("SA3.png"));
		Rarial[0] = ImageIO.read(new File("SA3.png"));
		Rarial[1] = ImageIO.read(new File("SA2.png"));
		Rarial[2] = ImageIO.read(new File("SA1.png"));
		
		fall[0] = ImageIO.read(new File("SF1.png"));
		fall[1] = ImageIO.read(new File("SF2.png"));	
		Rfall[0] = ImageIO.read(new File("SF1R.png"));
		Rfall[1] = ImageIO.read(new File("SF2R.png"));
		
		rShield = ImageIO.read(new File("SS1.png"));
		lShield = ImageIO.read(new File("SS1R.png"));
	}
